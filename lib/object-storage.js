...
ObjectStorage.prototype.create = function (container) {
	var req = new ObjectStorageRequest(this);
	return this.getUrl().then(function (url) {
		return req.put(url + '/' + container).end().then(function () {
			return Q.resolve();
		});
	});
};
